...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public List<TaskEntry> mTaskEntries;
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        //Set values
        holder.binding.taskDescription.setText(description);
        holder.binding.taskUpdatedAt.setText(updatedAt);

        // Programmatically set the text and color for the priority TextView
        String priorityString = "" + priority; // converts int to String
        holder.binding.priorityTextView.setText(priorityString);

        GradientDrawable priorityCircle = (GradientDrawable) holder.binding.priorityTextView.getBackground();
    ...
    class TaskViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TaskViewHolder(TaskLayoutBinding itemView) {
